...
st.set_page_config(page_title="Minimalist Collaborative Finance Chatbot - An LLM-powered Streamlit app")
...
with st.sidebar:
    ...
    st.markdown(
        ...
        <h1 style="text-align: center;">
            💬 Minimalist Collaborative Finance Chatbot
        </h1>
        """,
...
if 'generated' not in st.session_state:
    st.session_state['generated'] = ["I'm Minimalist Collaborative Finance Chatbot, How may I help You?"]
